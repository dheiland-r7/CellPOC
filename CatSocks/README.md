...
Note: because of typical UART serial bottlenecks its recommended that application sending data through the proxy meter their socket connection to 3 parallel for best performance
